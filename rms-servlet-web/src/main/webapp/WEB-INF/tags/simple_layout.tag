...
<body>
    <div class="demo-layout-transparent mdl-layout mdl-js-layout" style="background-color:blue;">
      ...
      <header class="mdl-layout__header mdl-layout__header--transparent">
        <div class="mdl-layout__header-row">
          ...
          <nav class="mdl-navigation">
            ...
            <a class="mdl-navigation__link" href="<%= request.getContextPath() %>/users/form">Add User</a>
